  ...
  return (
    <ol className="lg:border-1 rounded-md bg-white lg:flex lg:rounded-none lg:border-x lg:border-gray-200">
      {STEPS.map((step, index: number) => {
        ...
        // console.log(`${step.name} and URL:-${step.url}`,isCompleted, "Is Current step:", isCurrent)
              ...
              >
                <span className="flex-shrink-0">
                  <img
                    src={imgPath}
                    className={cn(
                      "flex size-20 items-center justify-center object-contain select-none",
                      {
