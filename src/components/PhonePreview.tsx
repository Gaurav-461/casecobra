...
const PhonePreview = ({
  ...
  if (color === "green") caseBackgroundColor = "bg-green-900";
    ...
    <AspectRatio ref={ref} ratio={3000 / 2001} className="relative">
      ...
      >
        <img
          ...
          className={cn(
            "phone-skew relative z-20 rounded-b-[10px] rounded-t-[15px] md:rounded-b-[20px] md:rounded-t-[30px]", caseBackgroundColor
          )}
          alt="Phone Preview"
        />
      </div>
