...
import { Icons, Phone, MaxWidthWrapper, Reviews } from "@/components/index";
...
const accordionData: AccordionItem[] = [
  ...
  },
  {
    ...
    content: "We currently support all iPhone models from iPhone 11 and newer.",
  },
  {
    title: "Is the case protective?",
    content:
      "Yes, our cases feature military-grade drop protection and raised edges to protect your screen and camera.",
  },
];
  ...
  return (
    <div className="grainy-light bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto flex flex-col items-center text-center lg:items-start lg:text-left">
              <div className="absolute -top-20 left-0 hidden w-28 lg:block">
                {/* it's purely visual gradient div and looks nice */}
                <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-slate-50 via-slate-50/50" />
                <img src="/snake-1.png" className="w-full" />
              </div>
              <h1 className="relative mt-16 w-fit text-pretty text-5xl font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="rounded-sm bg-green-600 px-2 text-white">
                  Custom
                </span>{" "}
                Phone Case
              </h1>
      ...
      <section className="bg-slate-100 py-24">
        ...
        <div className="mx-auto max-w-screen-xl select-none pt-16">
          <Reviews />
        </div>
      </section>
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="mt-2 text-center text-5xl font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl">
                Upload your photo and get{" "}
                <span className="mr-1 rounded-sm bg-green-600 px-2">
                  own case
                </span>
                now
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex grid-cols-2 flex-col items-center gap-40 md:grid">
              ...
              <div className="relative h-80 w-full max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 md:h-full md:justify-self-end lg:rounded-xl">
                <img
                  src="/horse.jpg"
