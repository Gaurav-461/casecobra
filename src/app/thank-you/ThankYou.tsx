      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-2 flex flex-auto flex-col">
            <h4 className="font-semibold">You made great choice!</h4>
            <p className="mt-2 text-sm">
              We at CaseCobra are honored to have you as our valued customer.
              Your purchase is a testament to our commitment to excellence and
